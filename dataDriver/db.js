...
DB.prototype.findEmail = function(coll, pattern){
    // Returns a promise which is resolve with find pattern matched email
    // of account of user
    // from the "coll" collection or is rejected by errors
...
DB.prototype.getAll = function(coll){
	var _this = this;
